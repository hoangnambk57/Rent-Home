...
class UserController extends Controller
{
    ...
    public function postLogin(Request $req)
    {
      $this->validate($req,[
         ...
         'email.required' => 'Bạn chưa nhập email.Xin vui lòng kiểm tra lại!',
         'pass.required' => 'Bạn chưa nhập password.Xin vui lòng kiểm tra lại!',
         'email.email' => 'Chưa nhập đúng định dạng email.Xin vui lòng kiểm tra lại!',
      ]);
      if (Auth::attempt(['email'=>$req->email,'password'=>$req->pass])){
        return redirect('home');
      } else{
        return redirect('login')->with('mess', 'Tài khoản không tồn tại.Xin vui lòng kiểm tra lại!');
      }
    }
}
